...
export default function Banner() {
  return (
    <section className="container px-4 pt-6 md:px-6">
      <div className="relative overflow-hidden rounded-3xl border border-white/15 shadow-2xl">
        ...
        <div className="relative z-10 px-6 py-12 sm:px-10 sm:py-14 lg:px-14 lg:py-20">
          ...
          <h1 className="fade-up delay-100 mt-4 max-w-xl text-4xl font-extrabold leading-tight text-white sm:text-5xl lg:text-6xl">
