...
export const getMovieDetails = async (movieId) => fetchFromAPI(`movie/${movieId}?language=vi`);
export const getMovieVideos = async (movieId) => fetchFromAPI(`movie/${movieId}/videos`);
export const getMovieReviews = async (movieId) => fetchFromAPI(`movie/${movieId}/reviews?language=vi`);
